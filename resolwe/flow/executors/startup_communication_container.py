...
DATA_CONNECTOR_NAME = os.getenv("DATA_CONNECTOR_NAME", "local")
...
class Uploader(threading.Thread):
    ...
    def receive_file_descriptors(
        ...
        connector_name, filenames, need_presigned_urls = json.loads(msg.decode())
        ...
        return (connector_name, dict(zip(filenames, fds)), need_presigned_urls)
        ...
        with client:
            while not self._terminating:
                ...
                try:
                    ...
                    to_connector = connectors[connector_name].duplicate()
...
class ProcessingProtocol(BaseProtocol):
    ...
    async def handle_upload_dirs(
        ...
        for directory in directories:
            ...
            # DATA_CONNECTOR_NAME equals "local".
            if DATA_CONNECTOR_NAME == "local":
